    ...
    <div class="app-container">
        <div class="sideNavBar">
            ...
            <div class="nav-links">
                ...
                <a href="emp_message.php" class="active"><i class="fas fa-envelope"></i> Messages</a>
                    ...
                    <div class="right-pane">
                        ...
                        <div class="status-card">
                            ...
                            <div class="profile">
                                ...
                                <div class="profile-info">
                                    <p class="client-name">Moon Ito</p>
                                    <p class="client-id">Client ID: 000123</p>
                                </div>
                            </div>
                            <div class="details">
                                <p>Assignee: <span><?php echo $user['fname'] . ' ' . $user['lname']; ?></span></p>
                                <p>Date Created: <span>09 Jul, 2024</span></p>
                                <p>Due Date: <span>14 Jul, 2024</span></p>
                                <p>Note: <span>None</span></p>
                            </div>
                        </div>
                        </div>
                    </div>
