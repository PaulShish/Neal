    ...
    <div class="app-container">
        <div class="sideNavBar">
            <div>
                ...
                <div class="nav-links">
                    <a href="cus_dashboard.php" class="active"><i class="fa-solid fa-house"></i> Dashboard</a>
        ...
        <div class="main-content">
            ...
            <div class="container">
                <div class="content">
                    <div class="todo-list">
                        <h2>Ticket Detail</h2>
                                <div style="border: 2px solid #ddd;color: #750CFF">
                                <div class="todo-list">
                                    <h1>Ticket ID: </h1>
                        ...
                        <div style="border: 2px solid #ddd;color: #750CFF">
                                ...
                                <div class="profile-info">
                                    <p class="client-name">Jolan Olmo</p>
                                    <p class="client-id">Employee ID:</p>
                                    </div>
                                    </div>
                                    <p style="color: black">Hello! I'm Jolan Olmo</p>
                                    <br>
                                    <p style="color: black">I’m your point of contact for Increment Technologies Inc. Please don’t hesitate to message me for any concerns or inquiries.</p>
                                    </div>
