    ...
    <div class="app-container">
        <div class="sideNavBar">
            ...
            <div class="nav-links">
                ...
                <a href="emp_account.php" class="active"><i class="fa-solid fa-user"></i> Account</a>
        ...
        <div class="main-content">
            ...
            <div class="container">
                <div class="content">
                    <div class="profile1"><img src="img/employee.jpg" alt="Profile Picture"><h1><u><?php echo $user['fname'] . ' ' . $user['lname']; ?></u></h1></div>
                        <p>Employee ID: </p>
